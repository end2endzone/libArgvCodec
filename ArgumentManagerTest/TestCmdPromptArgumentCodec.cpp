...
void prepareTestEncodeArgument(const char * iRawArguementValue, std::string & oEscapedArgument, std::string & oSystemArgumentValue)
{
  //arrange
  ArgumentList::StringList expectedArgs;
...
TEST_F(TestCmdPromptArgumentCodec, testEncodeArgument)
{
  ...
  //-----------------------------------------------------------------------------------
  {
    ...
    prepareTestEncodeArgument(argumentValue, actualEscapedArg, systemArgumentValue);
